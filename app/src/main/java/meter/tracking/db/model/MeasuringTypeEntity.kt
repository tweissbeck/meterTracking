 ...
 * @param unitSymbol a symbol associate with this measuring type
 * @author tweissbeck
 * @since 1.0.0
 */
@Entity
class MeasuringTypeEntity(@PrimaryKey val label: String, val decimal: Int = 0, val unitSymbol: String?)